...
export function handleSellSaleOrder(event: Sell): void {
  log.info('Event Sell Sale Order: id={}, token={}, currency={}, seller={}, price={}', [
...
export function handleBuySaleOrder(event: Buy): void {
  log.info('Event Buy Sale Order: id={}, token={}, currency={}, seller={}, price={}, amount={}', [
    event.params.orderId.toHex(),
  ...
  order.save();
  log.info('update order: tokenId={} success', [event.params.tokenId.toString()]);
  // create sale order transaction: Buy
  const saleOrderTransaction = new SaleOrderTransaction(event.params.orderId.toHex());
  saleOrderTransaction.order = event.params.orderId.toHex();
...
export function handleCancelSaleOrder(event: Cancel): void {
  log.info('Event Cancel Sale Order: id={}, token={}, currency={}, seller={}, price={}', [
    event.params.orderId.toHex(),
    event.params.tokenId.toString(),
    event.params.currency.toHexString(),
    event.params.seller.toHexString(),
